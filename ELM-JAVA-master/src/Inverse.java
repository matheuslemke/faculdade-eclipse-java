...
public class Inverse
{
	...
	/*
	 * Moore-Penrose generalized inverse maxtrix Theory:Full rank factorization
	 * [U S Vt] = SVD(A) <==> U*S*Vt = A C=U*sqrt(S) D=sqrt(S)*Vt <==>
	 * A=C*D,Full rank factorization MP(A) = D'*inv(D*D')*inv(C'*C)*C'
	 */
